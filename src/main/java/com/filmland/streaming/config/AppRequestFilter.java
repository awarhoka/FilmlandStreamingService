...
import com.filmland.streaming.service.JwtUserDetailsService;
...
public class AppRequestFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		final String requestTokenHeader = request.getHeader(ACCESS_TOKEN_COOKIE_NAME);
		...
		if (requestTokenHeader != null && requestTokenHeader.length() > 0 ) {
			...
			logger.warn("Request Header requires token");
		}
